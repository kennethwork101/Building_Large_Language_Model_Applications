...
def main(options):
    ...
    print(f"Number of vector: {len(embedding_data)}; Dimension of each data vector: {len(embedding_data[-1])}")
    ...
    response = llm_chain.invoke({"sentence": "the cat is on the table", "language": "spanish"})
