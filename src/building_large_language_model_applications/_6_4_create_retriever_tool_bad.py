...
def main(options):
    ...
    agent_executor = create_conversational_retrieval_agent(
        chat_llm, tools, memory_key="chat_history", verbose=True
    )
    ...
    client = openai.OpenAI(api_key="anything", base_url=f"http://0.0.0.0:{port}")
...
def Options():
    ...
    parser.add_argument(
        "--pathname", type=str, help="pathname", default="italy_travel.pdf"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--question", type=str, help="question", default="tell me a joke about science"
    )
    parser.add_argument("--repeatcnt", type=int, help="repeatcnt", default=1)
    parser.add_argument("--temperature", type=float, help="temperature", default=0.1)
    parser.add_argument(
        "--vectordb_type", type=str, help="vectordb_type", default="memory"
    )
    parser.add_argument(
